      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-surface-100">
        <div className="max-w-5xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-primary-900 mb-8 leading-tight tracking-tight">
            AI Case Intelligence for Lawyers that Delivers Winning
            Strategies
          </h1>
          <p className="text-2xl text-ink-600 mb-12 max-w-3xl mx-auto font-medium leading-relaxed">
            Transform your case analysis from a manual chore to a
            strategic advantage. Get actionable insights in minutes,
            not days.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-ink-600 max-w-3xl mx-auto font-medium">
              Legal Case Analysis is designed to deliver tangible
              benefits that directly impact your practice and
              outcomes.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-10 rounded-xl shadow-sm border border-border-200">
              ...
              <p className="text-ink-600 text-base leading-relaxed font-medium">
                Stop guessing on case outcomes. Accurately estimate
                win probability and avoid taking on losing cases.
              </p>
            </div>
            ...
            <div className="bg-white p-10 rounded-xl shadow-sm border border-border-200">
              ...
              <p className="text-ink-600 text-base leading-relaxed font-medium">
                Impress clients with data-backed insights and a
                strategic game plan for court or negotiation.
              </p>
            </div>
            ...
            <div className="bg-white p-10 rounded-xl shadow-sm border border-border-200">
              ...
              <p className="text-ink-600 text-base leading-relaxed font-medium">
                Help hours of digging, get a focused checklist of
                gaps, risks, and alternatives.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-surface-050">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-ink-600 max-w-3xl mx-auto font-medium">
              Our model analyzes 500K+ public court decisions spanning
              50+ years across all practice areas, judge patterns, and
              settlement outcomes.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 grid md:grid-cols-2 gap-6">
              <div className="bg-white p-8 rounded-xl border border-border-200 shadow-sm flex flex-col justify-center">
                ...
                <div className="text-base font-medium text-ink-500">
                  Average Case Analysis Time
                </div>
              </div>
              <div className="bg-white p-8 rounded-xl border border-border-200 shadow-sm flex flex-col justify-center">
                <div className="text-5xl font-extrabold text-accent-600 mb-3">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-12 relative">
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-primary-900 mb-4">
                1. Upload Case Details
              </h3>
              <p className="text-ink-600 text-base leading-relaxed max-w-xs mx-auto font-medium">
                Securely upload documents, discovery files, and
                transcripts. Our platform ingests and organizes
                everything for you.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-ink-600 text-base leading-relaxed max-w-xs mx-auto font-medium">
                View probability, settlement ranges, risk factors, and
                strategic recommendations. All done in seconds.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-surface-050">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-ink-600 max-w-3xl mx-auto font-medium">
              Whether you're a solo practitioner or a large firm, we
              have a plan that fits your needs. No hidden fees, just
              transparent value.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white p-10 rounded-xl border border-border-200 text-center shadow-sm">
              ...
              <p className="text-base text-ink-500 mb-8 font-medium">
                Get started with all the essential features to analyze
                your cases.
              </p>
            ...
            <div className="bg-surface-050 p-10 rounded-xl border border-border-200 text-center shadow-sm">
              ...
              <p className="text-base text-ink-500 mb-8 font-medium">
                Advanced collaboration, custom integrations, and
                dedicated support.
              </p>
              <div className="text-2xl font-bold text-accent-600 mb-10 py-4">
                Talk to Us
              </div>
              <Link
                href="/contact"
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-surface-100">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-2xl text-ink-600 mb-12 font-medium">
            Gain an unbeatable strategic advantage. Join thousands of
            lawyers who are building stronger cases with Legal Case
            Analysis.
          </p>
          <Link
            href="/signup"
