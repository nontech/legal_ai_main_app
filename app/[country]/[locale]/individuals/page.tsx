      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-surface-100">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-2xl text-ink-600 mb-12 max-w-3xl mx-auto font-medium leading-relaxed">
            Upload your documents, answer a few questions, and get a
            clear, plain‑language view of your legal situation – in
            minutes, not weeks. Know whether you have a case, what to
            do next, and when it’s worth speaking to a lawyer.
          </p>
          ...
          <p className="text-sm text-ink-500 mt-6 max-w-2xl mx-auto font-medium">
            No legal jargon. No commitment. Just structured, unbiased
            guidance so you don’t miss important deadlines or make
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-ink-600 max-w-3xl mx-auto font-medium">
              TheLawThing is built for people suddenly thrown into
              stressful legal situations – especially in Germany and
              the EU.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-border-200">
              ...
              <p className="text-ink-600 text-base leading-relaxed">
                Dealing with termination, warning letters, unfair
                treatment, unpaid salary, or severance disputes.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-border-200">
              ...
              <p className="text-ink-600 text-base leading-relaxed">
                Facing eviction threats, deposit conflicts, rent
                increases, or habitability issues.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-border-200">
              ...
              <p className="text-ink-600 text-base leading-relaxed">
                Who receive debt collection letters or find themselves
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-border-200">
              ...
              <p className="text-ink-600 text-base leading-relaxed">
                Contractor conflicts, minor property damage, and
                similar everyday disputes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl border border-border-200 shadow-sm">
              ...
              <p className="text-ink-500 italic mb-6">
              ...
              <p className="text-primary-900 font-medium">
                A clear "yes / no / maybe" assessment with reasons in
                plain language.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl border border-border-200 shadow-sm">
              ...
              <p className="text-primary-900 font-medium">
                Automatic alerts for key time limits and suggested
                next steps.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl border border-border-200 shadow-sm">
              ...
              <p className="text-ink-500 italic mb-6">
                "Is this worth spending hundreds of euros on a
                lawyer?"
              </p>
              <div className="h-px bg-border-200 mb-6"></div>
              <div className="mb-4">
              ...
              <p className="text-primary-900 font-medium">
                A preliminary view of case strength, likely outcomes,
                and whether legal fees make sense.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="text-ink-600 mb-2">
                  Upload your documents and describe what happened.
                  TheLawThing analyzes your situation and gives you:
                </p>
                <ul className="space-y-2 text-ink-600">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-accent-600 flex-shrink-0 mt-0.5" />{" "}
                    A straightforward case strength indicator: strong,
                    uncertain, or weak
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-accent-600 flex-shrink-0 mt-0.5" />{" "}
                    Key arguments in your favor – and potential
                    problems
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-accent-600 flex-shrink-0 mt-0.5" />{" "}
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <ul className="space-y-2 text-ink-600">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-accent-600 flex-shrink-0 mt-0.5" />{" "}
                    A personalized checklist tailored to your case
                    type
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-accent-600 flex-shrink-0 mt-0.5" />{" "}
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-accent-600 flex-shrink-0 mt-0.5" />{" "}
                    Overview of relevant options: negotiation,
                    mediation, or court
                  </li>
                </ul>
              </div>
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <ul className="space-y-2 text-ink-600">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-accent-600 flex-shrink-0 mt-0.5" />{" "}
                    Possible outcomes (win, settlement, dismissal) in
                    ranges
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-accent-600 flex-shrink-0 mt-0.5" />{" "}
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-accent-600 flex-shrink-0 mt-0.5" />{" "}
                    Cost‑benefit view: likely recovery vs. expected
                    legal costs
                  </li>
                </ul>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl border border-border-200 shadow-sm hover:border-primary-300 transition-colors cursor-pointer group">
              ...
              <p className="text-ink-600 mb-4 italic">
                "I was fired, warned, or treated unfairly at work."
              </p>
              <p className="text-ink-600 text-sm">
                Understand if protections like the German Employment
                Protection Act (KSchG) may apply and what the usual
                steps look like.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl border border-border-200 shadow-sm hover:border-primary-300 transition-colors cursor-pointer group">
              ...
              <p className="text-ink-600 mb-4 italic">
                "My landlord keeps part of my deposit, raises rent, or
                threatens eviction."
              </p>
              <p className="text-ink-600 text-sm">
                See what tenant rights under German rental law
                (Mietrecht) typically look like and what you can
            ...
            <div className="bg-white p-8 rounded-xl border border-border-200 shadow-sm hover:border-primary-300 transition-colors cursor-pointer group">
              ...
              <p className="text-ink-600 mb-4 italic">
                "I received a payment demand, contract penalty, or had
                an issue with a contractor."
              </p>
              <p className="text-ink-600 text-sm">
                Learn how similar small-claims disputes are usually
                resolved, and how to prepare.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-12 relative">
            ...
            <div className="text-center">
              ...
              <p className="text-ink-600 text-base leading-relaxed max-w-xs mx-auto font-medium">
                Securely upload letters, emails, contracts, dismissal
                notices, rental agreements, and other relevant files.
            ...
            <div className="text-center">
              ...
              <p className="text-ink-600 text-base leading-relaxed max-w-xs mx-auto font-medium">
                System matches your case against 500k+ similar cases,
                judges historical patterns, and settlement data.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-ink-600 text-base leading-relaxed max-w-xs mx-auto font-medium">
                Clear summary of where you stand legally, key
                deadlines, and recommended next steps.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl border border-border-200 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-xs font-bold text-ink-500 uppercase tracking-wide mb-1">
                    Before
                  </p>
                  <p className="text-ink-600 text-sm">
                    No idea if the termination was legal, scared to
                    confront employer.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-primary-900 font-medium text-sm">
                    Understood the 3‑week deadline, got a realistic
                    settlement expectation, and went into a lawyer
                    meeting prepared.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white p-8 rounded-xl border border-border-200 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-ink-600 text-sm">
                    Hours of Googling, conflicting advice, and fear of
                    high legal costs.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-primary-900 font-medium text-sm">
                    Clear assessment of which damages were valid vs
                    unfair, plus a step‑by‑step plan for negotiation.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl border border-border-200 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-ink-600 text-sm">
                    Anxiety, fear of court, and pressure to pay
                    immediately.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-primary-900 font-medium text-sm">
                    Understood what the letter meant, what the
                    collector could (and couldn’t) do, and how to
                    respond.
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-4xl mx-auto bg-white p-10 rounded-xl border border-border-200 shadow-sm">
          <div className="text-center mb-10">
            ...
            <p className="text-ink-600">
              You stay in control: you choose what to upload, what to
              keep, and whether to share the output with a lawyer.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-ink-600">
                Built with a focus on local legal procedures and
                deadlines.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-ink-600">
                Information-focused assistant that helps you prepare
                for a lawyer.
              </p>
            </div>
            <div className="text-center">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-surface-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-ink-600 max-w-3xl mx-auto font-medium">
              TheLawThing is designed to reduce the risk of spending
              money blindly on legal fees.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white p-10 rounded-xl border border-border-200 text-center shadow-sm">
              ...
              <p className="text-base text-ink-500 mb-8 font-medium">
                Quick viability signal: does this look worth exploring
                further? High‑level summary & key deadlines
              </p>
              <div className="text-5xl font-extrabold text-primary-900 mb-3">
                Free
              </div>
              <p className="text-base text-ink-500 mb-10 font-medium">
                3 cases per month
              </p>
              <Link
                href="/upload"
            ...
            <div className="bg-surface-050 p-10 rounded-xl border border-border-200 text-center shadow-sm">
              ...
              <p className="text-base text-ink-500 mb-8 font-medium">
                In‑depth analysis, action plan, and evidence
                checklist.
              </p>
              <div className="text-5xl font-extrabold text-accent-600 mb-3">
                €1.99
              </div>
              <p className="text-base text-ink-500 mb-10 font-medium">
                per case
          ...
          <p className="text-center text-ink-500 mt-8 max-w-2xl mx-auto text-sm">
            For more complex cases, we can connect you to partner law
            firms that receive your structured assessment as a
            starting point.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-surface-050">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-2xl text-ink-600 mb-12 font-medium">
            Turn anxiety and confusion into a clear plan. Understand
            your legal options, prepare better for lawyer meetings,
            and avoid missing important deadlines.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/case-analysis"
