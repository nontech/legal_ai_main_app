...
interface QuickResultsScreenProps {
  caseData?: any;
}

export default function QuickResultsScreen({
  caseData,
}: QuickResultsScreenProps) {
    ...
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl border-2 border-amber-200 p-8 text-center">
        ...
        <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
          Add detailed information about charges, evidence, witnesses,
          judge, and jury to receive comprehensive predictions and
          strategic recommendations tailored to your specific case.
        </p>

        <button
          onClick={() => router.push("/case-analysis/detailed")}
          className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-amber-500 to-amber-600 text-white rounded-xl font-bold text-lg hover:from-amber-600 hover:to-amber-700 transition-all duration-200 shadow-lg hover:shadow-xl"
        >
          <svg
            className="w-6 h-6"
            fill="none"
          ...
          <span>Add More Details for Accurate Analysis</span>
        </button>

        <p className="text-sm text-gray-600 mt-4">
          Takes approximately 5 more minutes
        </p>
      </div>
