...
export default function ResultsStep({
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      let filename = "Case_Analysis.pdf";
        ...
        >
            ...
            {caseInfo.jurisdiction && (
              <div className="flex items-center gap-2 text-xs sm:text-sm">
                ...
                <span className="sm:hidden">
                  {caseInfo.jurisdiction.state || "Unknown"}
                </span>
              </div>
            )}
            <div className="flex items-center gap-2 text-xs sm:text-sm">
          ...
          <div className="flex gap-2 flex-wrap justify-start lg:justify-end">
            ...
            <button
              ...
              className="p-2 hover:bg-gray-200 rounded transition-colors text-xs sm:text-sm flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
              title={
                isDownloadingPDF
                  ? "Generating PDF..."
                  : "Download as PDF"
