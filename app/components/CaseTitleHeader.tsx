          ...
          <div className="flex-1 min-w-0">
            <div className="max-w-4xl mx-auto w-full">
              <div className="mt-6 rounded-xl bg-white/80 backdrop-blur-md shadow-lg ring-1 ring-black/5">
                <div className="px-6 sm:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
                  {/* Title + Edit */}
                    ...
                    {isEditing ? (
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="flex-1 min-w-0 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-lg sm:text-xl font-semibold bg-white text-gray-900"
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors flex items-center gap-2 text-sm font-medium shrink-0"
                        >
                          {isSaving ? (
                            <>
                              <svg
                        ...
                        <button
                          ...
                          disabled={isSaving}
                          className="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 disabled:opacity-50 transition-colors text-sm font-medium shrink-0"
                        >
                          Cancel
                        </button>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {isOwner && !isLoading && (
                          <button
                            onClick={handleEdit}
                            className="p-1.5 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors shrink-0"
