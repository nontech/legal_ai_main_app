  ...
  public: {
    Tables: {
      ...
      court_levels: {
        ...
        Relationships: [
          {
            foreignKeyName: "court_levels_country_id_fkey";
            columns: ["country_id"];
            isOneToOne: false;
            referencedRelation: "countries";
            referencedColumns: ["id"];
      ...
      courts: {
        ...
        Relationships: [
          {
            foreignKeyName: "courts_country_id_fkey";
            columns: ["country_id"];
            isOneToOne: false;
            referencedRelation: "countries";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "courts_jurisdiction_id_fkey";
          ...
          {
            foreignKeyName: "courts_court_level_id_fkey";
            columns: ["court_level_id"];
            isOneToOne: false;
            referencedRelation: "court_levels";
            referencedColumns: ["id"];
          }
        ];
      };
